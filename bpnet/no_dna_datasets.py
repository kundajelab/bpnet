...
def _run_extractors(extractors, intervals, sum_tracks=False):
    """Helper function for AddedChannels_StrandedProfile
    """
    if sum_tracks:
...
@gin.configurable
class AddedChannels_StrandedProfile(Dataset):
    ...
    def __init__(self, ds,
        ...
        self.additional_bw_channels = additional_bw_channels
        self.exclude_dna = False
        # not specified yet
    ...
    def __getitem__(self, idx):
        ...
        if self.additional_bw_channels is not None and len(self.additional_bw_channels) > 0:
            self.added_channel_extractors = []
            for file in self.additional_bw_channels:
...
def my_bpnet_data(dataspec,
    ...
    return (AddedChannels_StrandedProfile(dataspec, peak_width,
            ...
            [('valid-peaks', AddedChannels_StrandedProfile(dataspec,
                                             peak_width,
                                             intervals_file=intervals_file,
                                             intervals_format=intervals_format,
                                             seq_width=seq_width,
                                             ...
                                             track_transform=track_transform,
                                             total_count_transform=total_count_transform)),
             ('train-peaks', AddedChannels_StrandedProfile(dataspec, peak_width,
                                             intervals_file=intervals_file,
                                             intervals_format=intervals_format,
                                             seq_width=seq_width,
                                             include_metadata=include_metadata,
...
def bpnet_data_gw(dataspec,
    ...
    train = AddedChannels_StrandedProfile(dataspec, peak_width,
                            seq_width=seq_width,
                            intervals_file=intervals_file,
    ...
    valid = [('train-valid-genome-wide',
              AddedChannels_StrandedProfile(dataspec, peak_width,
                              seq_width=seq_width,
                              intervals_file=intervals_file,
                              intervals_format='bed3+labels',
                              include_metadata=include_metadata,
    ...
    valid = valid + [
        ('valid-peaks', AddedChannels_StrandedProfile(dataspec, peak_width,
                                        seq_width=seq_width,
                                        intervals_file=None,
                                        intervals_format='bed3+labels',
                                        include_metadata=include_metadata,
